...
I am on the steering committee for the [Great Lakes Fishery Commission](http://www.glfc.org/)'s third Sea Lamprey International Symposium, SLIS III.  During one of our planning meetings, another member of the committee commented on the citation rate of some of the papers published in the [SLIS II proceedings](http://www.sciencedirect.com/science/journal/03801330/29/supp/S1).  I thought it might be useful to the group to see the number of citations for all the SLIS II papers.  
...
Then I wrote a function, `read.wos()`, to read in the Web of Science citation report, `savedrecs.txt`.
...
```{r}
datatable(slis2, options=list(pageLength=5), 
  caption="SLIS II papers, ordered by number of citations, 2003-2017")

datatable(other, options=list(pageLength=5),
