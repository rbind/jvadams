...
In preparation for mapping the results, I also downloaded county mapping data for Wisconsin from the [ggplot2](https://ggplot2.tidyverse.org/) package.
